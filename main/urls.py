...
from main.views import show_main, create_news, show_news, show_xml, show_json, show_xml_by_id, show_json_by_id, edit_news, delete_news, proxy_image
from main.views import create_news_flutter
from main.views import register
from main.views import login_user
from main.views import logout_user, add_news_entry_ajax
